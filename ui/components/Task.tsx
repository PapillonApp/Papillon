  ...
  ({
    ...
    return (
      <ListTouchable onPress={onPress}>
        <Stack animated layout={Animation(LinearTransition, "list")} card radius={20} style={{
          borderColor: theme.colors.text + "32",
          borderWidth: Platform.OS === "android" ? 0 : 1,
          backgroundColor: (Platform.OS === "android" && !theme.dark) ? "#FFF" : theme.colors.item,
          elevation: 2,
          overflow: "hidden"
        }}>
          <Stack animated layout={Animation(LinearTransition, "list")} padding={[16, 14]} gap={12} radius={20}
            ...
            {/* Bottom */}
            <Stack animated layout={Animation(LinearTransition, "list")} direction="horizontal" gap={8}
                   hAlign="center">
              ...
              {canComplete && (
                <Stack animated layout={Animation(LinearTransition, "list")} radius={300} inline hAlign="end"
                       vAlign="center" style={{ overflow: Platform.OS === "android" ? "hidden" : undefined }}>
                  <ListTouchable scaleTo={0.8} animated layout={Animation(LinearTransition, "list")}
                                 onPress={onToggle}>
                    <Stack
                      animated
