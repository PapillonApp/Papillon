...
export const StepTeacher = ({ isCurrent }: { isCurrent: boolean, sliderRef: React.RefObject<FlatList> }) => {
  const { topTeacher, topTeacherCount } = useWrappedStats();
          ...
          {step >= 0 && (
            <Stack animated layout={LinearTransition.springify().duration(1000)} gap={6} vAlign='center' hAlign='center' style={{ width: Dimensions.get('screen').width - 80, ...SHADOW_OVER_ANIMATED_BG }}>
              ...
              >
                ...
                >
                  <Papicons name="user" size={48} color='white' />
                </Reanimated.View>
              </Reanimated.View>
              <Reanimated.View
              ...
              >
                <Typography color='white' variant='h2' align='center'>
                  Ton professeur le plus vu aura été...
                </Typography>
              </Reanimated.View>
