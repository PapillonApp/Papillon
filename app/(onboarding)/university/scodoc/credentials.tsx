...
import { authenticateWithCredentials, ScodocAPI } from "@/services/scodoc/module";
...
const SCODOC_COLOR = "#1a5276";

const upperFirst = (str?: string) =>
    str ? str.charAt(0).toUpperCase() + str.slice(1).toLowerCase() : "";

export default function ScodocCredentials() {
    ...
    async function handleLogin() {
        ...
        try {
            ...
            if (!discovery.success || !discovery.data) {
                throw new Error(discovery.error || "Impossible de trouver les informations étudiantes");
            }
            ...
            const lastName = upperFirst(etudiant?.nom) || "ScoDoc";
            ...
            alert.showAlert({
                ...
                description:
                    "Impossible de se connecter à ScoDoc. Vérifie l'URL de ton établissement et tes identifiants.",
                icon: "TriangleAlert",
                color: "#D60046",
                withoutNavbar: true,
            });
        ...
        <KeyboardAvoidingView style={{ flex: 1, marginBottom: insets.bottom }} behavior="padding">
            ...
            >
                ...
                <Stack vAlign="start" hAlign="start" width="100%" gap={12}>
                    ...
                    <Typography variant="h1" style={{ color: "#FFF", fontSize: 32 }}>
                        {t("ONBOARDING_LOGIN_CREDENTIALS")} ScoDoc
                    </Typography>
                    <Typography variant="body1" style={{ color: "#FFFFFFCC" }}>
                        Entre l&apos;URL de ton instance ScoDoc et tes identifiants
                    </Typography>
                </Stack>
            </View>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
                <Stack padding={20} gap={10} style={{ paddingBottom: 40 }}>
                    <OnboardingInput
                        icon={"Link"}
                        placeholder={"URL ScoDoc (ex: https://scodoc.mon-univ.fr)"}
                        text={url}
                        setText={setUrl}
                        isPassword={false}
                        keyboardType={"url"}
