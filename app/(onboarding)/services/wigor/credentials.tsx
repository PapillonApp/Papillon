...
import { INSTANCES, loginWithCredentials } from "@studentsphere/linkgor";

const ANIMATION_DURATION = 100;

export default function WigorCredentials() {
  ...
  async function handleLogin(username: string, password: string) {
    if (!instance) {
      alert.showAlert({
        ...
        description: t("ONBOARDING_WIGOR_INSTANCE_NOT_FOUND"),
        icon: "AlertTriangle",
        color: "#D60046",
        withoutNavbar: true,
      });
    ...
    >
      ...
      >
        ...
        <Stack vAlign="start" hAlign="start" width="100%" gap={12}>
          ...
          >
            {t("ONBOARDING_LOGIN_CREDENTIALS")} {instance?.name || "Wigor"}
          </Typography>
        </Stack>
      </View>
