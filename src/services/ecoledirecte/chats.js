    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, ecoledirecte.studentReceivedMessages(account.authentication.session, account.authentication.account)];
            case 1:
                chats = _a.sent();
                return [2 /*return*/, chats.chats.map(function (chat) { return ({
                        id: chat.id.toString(),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!account.instance)
                    throw new ErrorServiceUnauthenticated("ecoledirecte");
                return [4 /*yield*/, ecoledirecte.readMessage(account.authentication.session, account.authentication.account, Number(chat.id))];
            case 1:
                message = _a.sent();
                return [2 /*return*/, {
                        ...
                        subject: chat.subject,
                        //@ts-ignore
                        attachments: message.files.map(function (a) { return ({
                            type: "file", // no links as attachements in ed
                            name: a.name,
                            url: "".concat(a.name, "\\").concat(a.id, "\\").concat(a.type)
                        }); })
                    }];
        }
    });
