...
function GetAvailableThemes() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://raw.githubusercontent.com/PapillonApp/datasets/refs/heads/main/themes/themes.json")];
                case 1:
                    f = _a.sent();
                    return [4 /*yield*/, f.json()];
                case 2:
                    r = _a.sent();
                    return [2 /*return*/, r.map(function (theme) {
                            return {
                                name: theme.name,
                                author: theme.author,
                                path: theme.path,
