...
var PronoteCredentials = function (_a) {
    ...
    var handleLogin = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
        var accountID_1, session_1, refresh, user, name_1, account, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pronote.loginCredentials(session_1, {
                            url: route.params.instanceURL,
                            kind: pronote.AccountKind.STUDENT,
                            username: username,
                            password: password,
                            deviceUUID: accountID_1
                ...
                case 1:
                    ...
                    _a = {
                        ...
                        authentication: __assign(__assign({}, refresh), { deviceUUID: accountID_1 })
                    };
                    ...
                    if (error_1 instanceof Error) {
                        switch (error_1.name) {
                            ...
                            case "AuthenticateError":
                                setError("Impossible de s'authentifier : " + error_1.message);
                                break;
    ...
    return (<LoginView serviceIcon={require("@/../assets/images/service_pronote.png")} serviceName="Pronote" onLogin={function (username, password) { return handleLogin(username, password); }} loading={loading} error={error}/>);
};
