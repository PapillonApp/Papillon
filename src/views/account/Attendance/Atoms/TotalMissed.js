...
var TotalMissed = function (_a) {
    var totalMissed = _a.totalMissed;
    var theme = useTheme();
      ...
      <View style={{
        ...
        <View>
          <Reanimated.View style={{
            ...
            <AnimatedNumber value={totalMissed.total.hours} style={{
            fontSize: 28,
            lineHeight: 28,
            fontFamily: "semibold",
        }}/>
            <NativeText animated style={{
            fontSize: 18,
            lineHeight: 18,
            marginBottom: 1,
        ...
        <View style={{
          ...
          <View style={{
            ...
            <AnimatedNumber value={totalMissed.unJustified.hours} style={{
            fontSize: 28,
            lineHeight: 28,
